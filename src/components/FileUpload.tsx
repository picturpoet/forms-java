  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="border-2 border-dashed border-grey-300 rounded-lg p-6 text-center hover:border-primary-400 transition-colors">
          <input
            type="file"
            accept=".pdf"
          ...
          <label htmlFor="form-pdf-upload" className="cursor-pointer">
            {formPdf ? (
              ...
              <div>
                ...
                <p className="text-xs text-grey-400 mt-1">Max 10MB</p>
              </div>
            )}
          </label>
        </div>
      ...
      <div>
        ...
        <div className="border-2 border-dashed border-grey-300 rounded-lg p-6 text-center hover:border-primary-400 transition-colors">
          ...
          <label htmlFor="supporting-files-upload" className="cursor-pointer">
            ...
            <p className="text-xs text-grey-400 mt-1">PDF, XLSX, CSV files</p>
          </label>
        </div>
        ...
        {supportingFiles.length > 0 && (
          <div className="mt-4 space-y-2">
            ...
            {supportingFiles.map((file, index) => (
              <div
                key={index}
                className="flex items-center justify-between bg-grey-50 p-3 rounded-lg border border-grey-200"
              >
