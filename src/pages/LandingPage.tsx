...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-7xl mx-auto px-6 lg:px-8 pt-8 pb-12">
        ...
        <div className="text-center space-y-6 mb-12">
          <div className="space-y-4">
            ...
            {/* Reduced spacing from H1 to body copy */}
          ...
          {/* CTAs - Reduced spacing from body to CTAs */}
        ...
        {/* Visual - Mac-style mockup with reduced spacing */}
        <div className="mb-12">
      ...
      {/* Section Header + Two Cards - Reduced spacing */}
      <section className="bg-gradient-to-b from-brand-light/30 to-white py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          {/* Features Preview - Reduced spacing */}
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-text mb-4">
